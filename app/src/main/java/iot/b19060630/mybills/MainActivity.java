...
import iot.b19060630.mybills.utils.BudgetDialog;
import iot.b19060630.mybills.utils.MoreDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addLVHeaderView() {
        ...
        totalBudget = headerView.findViewById(R.id.item_mainlv_top_iv_hide);

        topbudgetTv.setOnClickListener(this);
        headerView.setOnClickListener(this);
        totalBudget.setOnClickListener(this);
