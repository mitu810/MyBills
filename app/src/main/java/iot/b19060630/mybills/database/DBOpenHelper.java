package iot.b19060630.mybills.database;
...
//        创建表示类型的表
        ...
        db.execSQL(sql);
        //创建用户表
        sql = "create table user(id integer primary key autoincrement,username varchar(10),password varchar(50),email varchar(50))";
        db.execSQL(sql);
    }
